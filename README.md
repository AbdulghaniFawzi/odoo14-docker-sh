...
``` bash
curl -s https://raw.githubusercontent.com/abdulghanifawzi/odoo14-docker-sh/main/run.sh | sudo bash -s odoo14-one 10014 20014
```

to set up first Odoo instance @ `localhost:10014` (default master password: `bzs2022@1234`)

and

``` bash
curl -s https://raw.githubusercontent.com/abdulghanifawzi/odoo14-docker-sh/main/run.sh | sudo bash -s odoo14-two 11014 21014
```

to set up another Odoo instance @ `localhost:11014` (default master password: `bzs2022@1234`)
...
``` sh
$ git clone https://github.com/abdulghanifawzi/odoo14-docker-sh.git
